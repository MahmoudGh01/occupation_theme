...
class _JobApplicationState extends State<JobApplication> {
  ...
  Future<Map<String, dynamic>> fetchJobDetails(String jobID) async {
   ...
   Color color = const Color(0x1A246BFD);

   Color textcolor = const Color(0xff246BFD);
                              ...
                              children: [
                                Row(
                                  children: [
                                    SizedBox(
                                        width: width/1.8,
                                        child: Text(jobTitle,style: urbanistSemiBold.copyWith(fontSize: 19 ),maxLines: 1,overflow: TextOverflow.ellipsis,)),
                                  ],
                                ),
                                SizedBox(height: height/80,),
                                Text(location,style: urbanistMedium.copyWith(fontSize: 16 ,color: JobColor.textgray),maxLines: 1,overflow: TextOverflow.ellipsis,),
                              ],
                            ),
                            const Spacer(),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(status,style: urbanistSemiBold.copyWith(fontSize: 10,color: textcolor)),
                              ),
                            ),
                          ],
                        ),
